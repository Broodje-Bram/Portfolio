  ...
  <header id="header">
    <div class="header-container">
      ...
      <nav class="header-nav">
        ...
        <ul>
          <li><router-link to="/" title="Home">.Bram()</router-link></li>
          ...
          <li><a href="mailto:Bramgoudsmid@hotmail.com" title="Send me an email">.contact()</a></li>
          <li class="social-link">
            <a href="https://www.linkedin.com/in/bram-goudsmid-%F0%9F%92%BB-ab2401225//" target="_blank" title="LinkedIn">
              <svg class="ico" viewBox="0 0 16 16" role="img" aria-labelledby="LinkedinIcoTitle">
          ...
          <li class="social-link">
            <a href="https://github.com/Broodje-Bram" target="_blank" title="GitHub">
              <svg class="ico" viewBox="0 0 16 16" role="img" aria-labelledby="GithubIcoTitle">
